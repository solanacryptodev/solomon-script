      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-8">
            <A href="/privacy" class="text-sm hover:text-teal-light transition">
              PRIVACY
            </A>
            <A href="/terms" class="text-sm hover:text-teal-light transition">
              TERMS
            </A>
            <A href="/contact" class="text-sm hover:text-teal-light transition">
              CONTACT
            </A>
          </div>
        </div>
