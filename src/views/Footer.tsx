      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-8">
            <button class="text-sm hover:text-teal-light transition">PRIVACY</button>
            <button class="text-sm hover:text-teal-light transition">TERMS</button>
            <button class="text-sm hover:text-teal-light transition">CONTACT</button>
          </div>
        </div>
      </div>
    </footer>
