  ...
  return (
    <nav class="bg-navy text-white py-4 shadow-md">
      <div class="container mx-auto px-4 flex justify-between items-center">
        <NavLink href="/" class="flex items-center text-xl font-bold">
        ...
        <div class="flex space-x-6">
          <NavLink href="/" class="hover:text-teal-light transition" end>
            HOME
          </NavLink>
          <NavLink href="/topics" class="hover:text-teal-light transition" end>
            TOPICS
          </NavLink>
          <NavLink href="/about" class="hover:text-teal-light transition" end>
            ABOUT
          </NavLink>
        </div>
      </div>
